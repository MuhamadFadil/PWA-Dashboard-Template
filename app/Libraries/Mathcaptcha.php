...
class Mathcaptcha
{
    ...
    public function init($config = array())
    {
        ...
        else
        {
            ...
            $this->language = $locale = service('request')->getLocale();
        }
...
$_SESSION['mathcaptcha_answer'] = $answer;
    ...
    private function compile_question($phrase, $numbers = array())
    {
        ...
        $question_phrase = lang('mathcaptcha_lang.'.$phrase);
    ...
    {
        $mathcaptcha_answer = $_SESSION['mathcaptcha_answer'];
    ...
    private function numeric_to_string($number)
    {
        if (is_numeric($number) && $number >= MATHCAPTCHA_NUMERIC_TEXT_RANGE_LOW && $number <= MATHCAPTCHA_NUMERIC_TEXT_RANGE_HIGH)
        {
            ...
            return lang('mathcaptcha_lang.mathcaptcha_numeric_word_'.$number);
        }
        else
        {
            return FALSE;
