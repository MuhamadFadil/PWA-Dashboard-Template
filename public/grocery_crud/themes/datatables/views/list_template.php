<?php
	...
	$this->set_css($this->default_theme_path.'/datatables/css/dataTables.bootstrap.min.css');
	...
	$this->set_js_lib($this->default_theme_path.'/datatables/js/dataTables.bootstrap.min.js');
